...
from muxserve.flexserver.sampler import GreedySampler
...
class LlamaModel(nn.Module):
    ...
    def __init__(
        ...
        num_hidden_layers = (num_hidden_layers if num_hidden_layers else
...
class LlamaForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.model = LlamaModel(config, quant_config, num_hidden_layers,
        ...
        if self.post_process:
            ...
            self.lm_head = ParallelLinear.column(config.hidden_size,
                                                 ...
                                                 gather_output=False,
                                                 quant_config=None)
            self.sampler = GreedySampler(config.vocab_size)
